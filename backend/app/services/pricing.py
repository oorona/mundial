...
This module is duplicated **verbatim** in ``bot/services/pricing.py`` — the bot
and backend are separate Python packages that share one Postgres database and the
